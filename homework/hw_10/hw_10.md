...
What difference does it make if you convert color to a character vector
before you make the model? Note that this is probably what you want to
do in general, unless you really know what you’re doing.
...
argument as to which model is more useful. Bonus: Should the data have
been pre-processed before making these models?
