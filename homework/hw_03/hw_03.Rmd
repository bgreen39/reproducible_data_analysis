---
title: "Homework 3 : Vectors, types, and coercion"
...
This is a "character" vector because the 1 and 2 were converted to a character.
```{r}
c(1,2,"a")
```
This is a "numeric" vector because the TRUE and FALSE were converted to a numeric vector (where TRUE=1 and False=2)
```{r}
c(TRUE,FALSE,2)
```
